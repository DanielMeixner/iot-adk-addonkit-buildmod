...
:: ---------------------------------------------------------------------
set defaultappx=RdClient.Windows_10.1.844.0_x86
set defaultappxid=Microsoft.MicrosoftRemoteDesktopPreview
set dependencylist=Microsoft.VCLibs.x86.14.00 Microsoft.NET.Native.Runtime.1.1 Microsoft.NET.Native.Framework.1.2 Microsoft.VCLibs.x86.12.00.Universal
